...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { chattiness: @preference.chattiness, music: @preference.music, pets: @preference.pets, smoking: @preference.smoking }
    end
  ...
  test "should update preference" do
    patch :update, id: @preference, preference: { chattiness: @preference.chattiness, music: @preference.music, pets: @preference.pets, smoking: @preference.smoking }
    assert_redirected_to preference_path(assigns(:preference))
  end
